/**
 * Chatbot Q&A data for Velvet Rose.
 *
 * Structure:
...
const chatbotData = {
  greeting:
    'Hi there! 💄 Welcome to our Velvet Rose. How can I help you today? Pick a topic below or type your question.',
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            'All prices on Velvet Rose are displayed in **RON (Romanian Lei)**.',
        },
      ],
    },
    {
