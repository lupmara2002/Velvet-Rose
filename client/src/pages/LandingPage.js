...
import { Box, Typography, Fab, Button, FormControl, InputLabel, Select, MenuItem, TextField, InputAdornment, Chip } from '@mui/material';
  ...
  const renderProducts = (products, lastRef) => (
    ...
    >
      {products.map((product, idx) => {
        ...
        const offer = offers.find((o) => o.active && o.category === product.category) ?? null;
        return (
          ...
          <Link to={`/product/${product._id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
            ...
            >
              <Box sx={{ position: 'relative', overflow: 'hidden' }}>
                ...
                {offer && !outOfStock && (
                  <Chip
                    icon={<LocalOfferRoundedIcon sx={{ fontSize: '13px !important', color: '#fff !important' }} />}
