...
import { useOfferForCategory } from '../context/OffersContext';
...
const ProductDetail = () => {
  ...
  const offer = useOfferForCategory(product?.category);
      ...
      >
        ...
        <CardContent sx={{ px: 4, pb: 4 }}>
          ...
          {offer && product.stock > 0 && (
            <Chip
              icon={<LocalOfferRoundedIcon sx={{ fontSize: '15px !important', color: '#8C5E6B !important' }} />}
